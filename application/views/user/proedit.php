...
<form method="post" action="<?php echo base_url('user/Product/update/'.$item->id);?>">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" value="<?php echo $item->category_id; ?>">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" value="<?php echo $item->subcategory_id; ?>">
